...
const Deliverymap = () => {
  ...
  const acceptOrder = async () => {
    const data = await confirmOrder(orderData?.orderId, myLocation);
    if (data) {
      if (data.order) {
  ...
  const orderPickedUp = async () => {
    ...
    if (data) {
      if (data.order) {
        ...
        console.error("Error picking up order: ", data);
      }
    } else {
      Alert.alert("Error picking up order", "Please try again later");
    }
  ...
  const orderDelivered = async () => {
    ...
    if (data) {
      if (data.order) {
        ...
        Alert.alert(
          "Error updating deliver status of order",
          "Please try again later"
        );
        console.error("Error updating deliver status of order: ", data);
      }
    } else {
      Alert.alert("Error picking up order", "Please try again later");
    }
